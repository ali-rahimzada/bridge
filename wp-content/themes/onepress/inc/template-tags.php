...
if ( ! function_exists( 'onepress_site_header' ) ) {
	...
	function onepress_site_header() {
		...
		<header id="masthead" class="<?php echo esc_attr( join( ' ', $classes ) ); ?>" role="banner">
            <div class="header_inner clearfix" id="search_container" style="display: none;">
                <form role="search" id="searchform" action="http://test/" class="qode_search_form" method="get" style="height: 50px;">
                    <div>
                        <div class="container_inner clearfix">
                            <input type="text" placeholder="Search" name="s" class="qode_search_field" autocomplete="off" style="color: #ffffff;background-color: #ff8738; width: 100%; padding:12px 80px;">
				...
				<div class="header_inner_right">
                    <div class="side_menu_button_wrapper right">
                        <div class="side_menu_button">
                            <a class="search_button search_slides_from_window_top normal" onclick="toggle_search();" href="javascript:void(0)">
                                <i class="fas fa-search"></i>
                            </a>
                            <a class="side_menu_button_link normal opened" href="javascript:void(0)">
